...
var instrucciones = ["Use arrows", "Move images", "Complete the puzzle"];

// Arreglo para ir guardando los movimientos que se vayan realizando

let movimientos = [];

let actualizarFlecha = function (direccion) {
...
function capturarTeclas() {
  document.body.onkeydown = function (evento) {
    if (
      evento.key === codigosDireccion.ABAJO ||
      evento.key === codigosDireccion.ARRIBA ||
      evento.key === codigosDireccion.DERECHA ||
      evento.key === codigosDireccion.IZQUIERDA
    ) {
